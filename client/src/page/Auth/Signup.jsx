  ...
  return (
    <div className="h-screen bg-cyan-50 overflow-hidden relative">
      ...
      <div className="container h-screen flex items-center justify-center px-4 sm:px-8 md:px-20 mx-auto">
        ...
        <div className="w-full md:w-2/4 h-auto md:h-[75vh] bg-white rounded-lg md:rounded-r-lg md:rounded-l-none relative p-8 sm:p-12 md:p-16 shadow-lg shadow-cyan-200 overflow-y-auto">
